...
/**
 * PostPagesPageIdIncidentTemplatesTemplate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostPagesPageIdIncidentTemplatesTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postPagesPageIdIncidentTemplates_template';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Name of the template, as shown in the list on the \"Templates\" tab of the \"Incidents\" page
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title Title to be applied to the incident or maintenance when selecting this template
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string $body The initial message, created as the first incident or maintenance update.
     *
     * @return self
     */
