...
/**
 * DeletePagesPageIdPageAccessUsersPageAccessUserIdComponents Class Doc Comment
 *
 * @category Class
 ...
 */
class DeletePagesPageIdPageAccessUsersPageAccessUserIdComponents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deletePagesPageIdPageAccessUsersPageAccessUserIdComponents';
    ...
    */
     ...
     * Sets component_ids
     *
     * @param string[]|null $component_ids List of components codes to remove.  If omitted, all components will be removed.
     *
     * @return self
     */
