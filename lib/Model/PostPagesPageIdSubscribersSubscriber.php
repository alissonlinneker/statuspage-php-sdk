...
/**
 * PostPagesPageIdSubscribersSubscriber Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostPagesPageIdSubscribersSubscriber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postPagesPageIdSubscribers_subscriber';
    ...
    protected static $setters = [
        ...
        'page_access_user' => 'setPageAccessUser',
    ...
    protected static $getters = [
        ...
        'page_access_user' => 'getPageAccessUser',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('page_access_user', $data ?? [], null);
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email The email address for creating Email and Webhook subscribers.
     *
     * @return self
     */
     ...
     * Sets endpoint
     *
     * @param string|null $endpoint The endpoint URI for creating Webhook subscribers.
     *
     * @return self
     */
    ...
    /**
     * Gets page_access_user
     *
     * @return string|null
     */
    public function getPageAccessUser()
    {
        return $this->container['page_access_user'];
    }

    /**
     * Sets page_access_user
     *
     * @param string|null $page_access_user The code of the page access user to which the subscriber belongs.
     *
     * @return self
     */
    public function setPageAccessUser($page_access_user)
    {
        if (is_null($page_access_user)) {
            throw new \InvalidArgumentException('non-nullable page_access_user cannot be null');
        }
        $this->container['page_access_user'] = $page_access_user;
     ...
     * Sets component_ids
     *
     * @param string[]|null $component_ids A list of component ids for which the subscriber should recieve updates for. Components must be an array with at least one element if it is passed at all. Each component must belong to the page indicated in the path.
     *
     * @return self
     */
