...
/**
 * PostPagesPageIdPageAccessGroupsPageAccessGroupIdComponents Class Doc Comment
 *
 * @category Class
 ...
 */
class PostPagesPageIdPageAccessGroupsPageAccessGroupIdComponents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postPagesPageIdPageAccessGroupsPageAccessGroupIdComponents';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['component_ids'] === null) {
            $invalidProperties[] = "'component_ids' can't be null";
        }
     ...
     * Sets component_ids
     *
     * @param string[] $component_ids List of components codes to set on the page access group
     *
     * @return self
     */
